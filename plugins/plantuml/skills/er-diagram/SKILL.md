...
description: This skill provides PlantUML entity-relationship diagram syntax reference. Use when writing, creating, or debugging PlantUML ER diagrams. Applies when users mention "ER diagram", "entity relationship", "database schema", "entity", "relationship", "cardinality", "foreign key", or need to diagram database models, data relationships, or schema design in PlantUML.
---

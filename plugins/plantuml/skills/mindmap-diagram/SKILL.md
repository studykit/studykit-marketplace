...
description: This skill provides PlantUML MindMap diagram syntax reference. Use when writing, creating, or debugging PlantUML mind maps. Applies when users mention "mind map", "mindmap", "brainstorm", "idea map", "concept map", or need to diagram hierarchical ideas, topic trees, or brainstorming sessions in PlantUML.
---

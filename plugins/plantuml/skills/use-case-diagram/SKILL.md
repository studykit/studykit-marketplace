...
description: This skill provides PlantUML use case diagram syntax reference. Use when writing, creating, or debugging PlantUML use case diagrams. Applies when users mention "use case diagram", "actor", "use case", "system boundary", or need to diagram user interactions, system requirements, or functional specifications in PlantUML.
---

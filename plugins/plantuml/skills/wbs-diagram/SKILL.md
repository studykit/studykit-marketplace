...
description: This skill provides PlantUML Work Breakdown Structure (WBS) diagram syntax reference. Use when writing, creating, or debugging PlantUML WBS diagrams. Applies when users mention "WBS", "work breakdown structure", "task hierarchy", "project decomposition", or need to diagram project breakdown, deliverable structures, or task trees in PlantUML.
---

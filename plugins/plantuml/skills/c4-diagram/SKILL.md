...
description: This skill provides C4-PlantUML diagram syntax reference using the C4 model stdlib. Use when writing, creating, or debugging C4 architecture diagrams in PlantUML. Applies when users mention "C4 diagram", "C4 model", "system context diagram", "container diagram" (in C4 context), "C4 component", "C4 deployment", "C4 dynamic diagram", "C4 sequence", "software architecture diagram", "Person", "System_Boundary", "Container_Boundary", or need to diagram software architecture using the C4 model abstraction levels in PlantUML.
---

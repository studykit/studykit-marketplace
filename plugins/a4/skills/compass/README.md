...
- **Primary file:** `plugins/a4/skills/compass/SKILL.md`
- **Current behavior:** Acts as the navigation entry point for the a4 pipeline. It inspects existing `a4/` artifacts first and then recommends or invokes the next skill.

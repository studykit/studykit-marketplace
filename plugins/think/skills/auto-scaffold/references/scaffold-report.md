# Scaffold Report Template

## File Path

`A4/<topic-slug>.scaffold.md`
...
sources:
  - file: <topic-slug>.arch.md
    ...
    sha: <git hash-object>
scaffold_commit: <git hash of scaffold commit>
---
```
...
| # | Issue | Stage | Auto-fix | Result |
|---|-------|-------|----------|--------|
| 1 | <description> | arch / environment | <what was tried> | FIXED / UNFIXED |
...
- Project Structure — only on fresh scaffold (not incremental)
...
- Each scaffold run is preserved as its own artifact via revision tracking
